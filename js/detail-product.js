...
document.addEventListener("DOMContentLoaded", function () {
  async function getProductById(productId) {
    ...
    <div class="text-left">
        <div class="mb-10">
            <h1 class="text-3xl font-semibold mb-4">${data.product_name}</h1>
            <p class="text-xl font-light leading-loose" id="product-description-text">
        ...
        <div class="mb-10">
            ...
            <p class="text-xl">${data.product_material}</p>
        </div>
        <div class="mb-10">
            <h2 class="text-2xl font-semibold">Kategori:</h2>
            <p class="text-xl">${data.product_category}</p>
        </div>
        <div class="mb-10">
            <h2 class="text-2xl font-semibold">Tipe:</h2>
            <p class="text-xl">${data.product_type}</p>
        </div>
    </div>
    `;
      };
